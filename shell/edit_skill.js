...
(async function main() {
  ...
  try {
    ...
    const skill_id = process.argv[2];
    const skill_name = process.argv[3];

    const data = sbt.editSkillABI(skill_id, skill_name);
    ...
    const sql = 'INSERT INTO skills (skill_id, skill_name) VALUES ('+skill_id+',"'+skill_name+'") ON DUPLICATE KEY UPDATE skill_name = "'+skill_name+'";';
